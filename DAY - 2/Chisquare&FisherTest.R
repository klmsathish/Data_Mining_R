...
#chi square test
chisq.test(newspaper_gender_table)

#Fisher Test
fisher.test(newspaper_gender_table)

#Pearson chi-Squared test, the Likelihood Ratio chi-Squared test
assocstats(newspaper_gender_table)
